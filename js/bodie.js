...
export const BODIE_TIPS = [
  ...
  { id:'merchant_lightleaf',   icon:'🫙', merchant:true, check: s => s.merchant?.effect?.id === 'lightleaf',        text:"Hi! Im Bodie. Light-Leaf Oil is active! 🫙 Your crops take up zero barn space for the next half hour. Harvest away!" },
